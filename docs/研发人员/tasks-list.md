...
| T-36 | 研发人员文档健全 | 研发设计 | `done` | T-07、T-08、T-34、T-35 | 已在 `docs/研发人员/` 新增研发实现说明、核心算法与性能优化说明、构建运行与发布说明、研发自查清单，并同步升级技术设计和 PRD 评审记录 |
...
| 2026-07-08 | 根据项目经理、需求分析师和测试人员文档健全研发人员文档：升级 `tech-design.md` 为当前实现口径，重写 `prd-review.md`，新增 `研发实现说明.md`、`核心算法与性能优化说明.md`、`构建运行与发布说明.md`、`研发自查清单.md`；新增 T-36 并标记为 `done`。 |
